...
export const alt = 'Administrador de consorcio en CABA — Dominium'
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              Administrador de consorcio en tu barrio.
            </div>
            <div
              style={{
                display: 'flex',
            ...
            >
              Operamos en los principales barrios de CABA y AMBA. Auditá tu liquidación gratis.
            </div>
          </div>
          ...
          >
            <div style={{ display: 'flex', flexDirection: 'column' }}>
              ...
              >
                dominium.com.ar/administrador-consorcio
              </div>
            </div>
            <div
              style={{
