    ...
    >
      <div className="mx-auto max-w-[1120px] px-6 flex flex-col items-center gap-16">
        ...
        >
          ...
          >
            Dominium nació para transformar la forma en que se administran los
            consorcios. Combinamos tecnología, transparencia y un equipo que
            entiende el problema de adentro.
          </p>
        </div>
