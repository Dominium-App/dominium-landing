      ...
      <div className="mx-auto max-w-[1120px] px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            >
              ¿Pensando en dejar<br />la administración?
            </h2>
            <p
              className="text-[17px] leading-relaxed max-w-[440px]"
              style={{ color: 'rgba(255,255,255,0.75)' }}
            >
              Tenés una cartera de edificios construida durante años. Dominium te ofrece una transición digna: 18 meses de comisiones por el traspaso de tus consorcios, y la certeza de que tus clientes quedan en las mejores manos.
            </p>
              ...
              {benefits.map((b, i) => (
                <li key={i} className="flex items-start gap-3">
                  <CheckCircle2
                    ...
                    aria-hidden="true"
                  />
                  <span className="text-[15px] text-white leading-snug">{b}</span>
                </li>
              ))}
            </ul>
            ...
            >
              ...
              <div className="flex flex-col gap-0">
                {[
                  ...
                  { step: '03', text: 'Ingreso garantizado mientras descansás' },
                ].map((item, i, arr) => (
                  <div key={i} className="flex gap-4">
                    ...
                    <div className="flex flex-col items-center">
                      <div
                        ...
                        style={{
                          backgroundColor: i === arr.length - 1 ? '#8ABF9A' : 'rgba(255,255,255,0.12)',
                          color: i === arr.length - 1 ? 'var(--color-accent)' : 'rgba(255,255,255,0.7)',
                        }}
                        aria-hidden="true"
                      >
                        {item.step}
                      ...
                      {i < arr.length - 1 && (
                        <div
                          ...
                          style={{ backgroundColor: 'rgba(255,255,255,0.15)', minHeight: '24px' }}
                          aria-hidden="true"
                        />
                      )}
                    </div>
                    ...
                    <p
                      ...
                      style={{
                        color: i === arr.length - 1 ? '#8ABF9A' : 'rgba(255,255,255,0.75)',
                        fontWeight: i === arr.length - 1 ? 600 : 400,
                        paddingBottom: i < arr.length - 1 ? '16px' : '0',
                      }}
                    >
                      {i === arr.length - 1 ? '= ' : ''}{item.text}
                    </p>
                  </div>
                ))}
              </div>
